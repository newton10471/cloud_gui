...
class InstancesControllerTest < ActionController::TestCase
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post :create, instance: { baseimage: @instance.baseimage, cpus: @instance.cpus, hostname: @instance.hostname, ipaddr: @instance.ipaddr, memory: @instance.memory, usercomment: @instance.usercomment }
    end
  ...
  test "should update instance" do
    put :update, id: @instance, instance: { baseimage: @instance.baseimage, cpus: @instance.cpus, hostname: @instance.hostname, ipaddr: @instance.ipaddr, memory: @instance.memory, usercomment: @instance.usercomment }
    assert_redirected_to instance_path(assigns(:instance))
  end
